package com.altafjava.control.afterfinally;
...
public class AbortExecutionAspect {
	...
	@After("execution(* com.altafjava.advice.Calculator.*(..))")
	public void controlExecution(JoinPoint joinPoint) throws Throwable {
		String methodName = joinPoint.getSignature().getName();
		if ("multiply".equals(methodName)) {
			throw new RuntimeException("Simulated exception in After Finally Advice");
		}
	}
